...
interface BotonLinkProps {outline?: boolean; color?: string; direction: string; text: string; textColor?: string}
 ...
 */
const BotonLink: React.FC<BotonLinkProps> = ({outline = false, color = "white", direction, text, textColor = "white"}) => {
  return (
