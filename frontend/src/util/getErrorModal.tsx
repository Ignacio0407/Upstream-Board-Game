 ...
 */
function handleVisible(setVisible:Function, visible:boolean) {
    setVisible(!visible);
}
/**
 ...
 * @param {string} [message=""] - The message to display inside the modal. If no message is provided, the modal is not rendered.
 * 
 ...
 */
export default function getErrorModal(setVisible, visible = false, message = "") {
    if (message) {
        const closeBtn = (
